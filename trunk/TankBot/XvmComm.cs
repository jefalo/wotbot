...
namespace TankBot
{
    ...
    class XvmComm
    {
        ...
        public void processMessage(string message)
        {
            ...
            //Trace.WriteLine("send message " + message.Split('@').Length + " " + message.Length + " " + message);
        ...
        private void displayInfoThread()
        {
            while (true)
            {
                ...
                str += "\r\n" + "focusTargetUpdated: " + tb.focusTargetUpdated;
                str += "\r\n" + "messageCount: " + this.messageCnt;
                str += "\r\n" + "map_scale: " + tb.mapSacle;
                str += "\r\n" + "support: " + tb.support();
                str += "\r\n" + "aiming_circle: " + (DateTime.Now - tb.aimStartTime).TotalSeconds;
                str += "\r\n" + "cannot_move: " + tb.cannot_move;
                str += "\r\n" + "g_degree_diff: " + tb.gDegreeDiff;
                str += "\r\n" + "Sniper Level: " + SniperMode.sniper_level;
                str += "\r\n" + "Status: " + tb.status;
                str += "\r\n" + "Mytank Name: " + tb.myTank.tankname + " " + tb.myTank.vInfo.tier + " " + tb.myTank.vInfo.vClass;
                str += "\r\n" + "Health: " + tb.myTank.health;
                str += "\r\n" + "Speed: " + tb.myTank.speed;
                str += "\r\n" + "Focus: " + tb.focusTarget;
                str += "\r\n" + "time_left: " + tb.timeLeft;
                str += "\r\n";
                str += "\r\n" + RateCount.toStr();
                str += "\r\n";
                str += "\r\n" + v_log;
