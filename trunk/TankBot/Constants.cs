...
namespace TankBot
{
    ...
    public class MapDef
    {
        public static Dictionary<string, Tuple<Point, Point>> boundingBox = new Dictionary<string, Tuple<Point, Point>>()
        {
            ...
            {"43_north_america", new Tuple<Point,Point> (new Point(-500.0 ,-500.0 ), new Point(500.0 , 500.0))},
        ...
        public static Dictionary<string, Tuple<Point, Point>> basePos = new Dictionary<string, Tuple<Point, Point>>()
        {
            ...
            //43_north_america is wrong actually
            {"43_north_america", new Tuple<Point, Point> ( new Point(-400.600006 , -400.100006), new Point( 380.300018 , 400.700012))},            
